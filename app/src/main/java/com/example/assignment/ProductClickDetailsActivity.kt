...
class ProductClickDetailsActivity : AppCompatActivity() {
    ...
    private lateinit var productMvvm: MainViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        productMvvm = ViewModelProviders.of(this).get(MainViewModel::class.java)

        getProductInfoFromIntent()

        setInformationInViews()

        productMvvm.getProductDetail(productId).observe(this) { product ->
    ...
    private fun getProductInfoFromIntent() {
        ...
        productId = intent.getIntExtra(
            ...
            0
        ) // Provide a default value for getIntExtra
